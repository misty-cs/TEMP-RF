...
for seed in $SEEDS; do
  for w in 1 2 3; do
    ...
    T2R_FORCE_DAYS_KEEP="$w" $PY -u run_experiment.py --dataset_layout wisig_full --data_root data --wisig_full_receiver node24-16 --device_shift 0 --n_known 12 --n_unknown 4 --init_day 1 --finetune_days 2 --traj_day 3 --test_day 4 \
