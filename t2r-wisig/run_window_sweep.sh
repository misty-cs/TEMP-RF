#!/bin/bash
# Forced-window WiSig sweep for the multi-day prototype claim.
#
# Protocol:
#   Day 1: train
#   Day 2: fine-tune
#   Day 3: reference/calibration
#   Day 4: test
#
# Windows:
#   W=1 -> Day 3 only
...
for w in 1 2 3; do
  for seed in $SEEDS; do
    ...
    mkdir -p "$out"
    echo "=== WiSig W=$w seed $seed start $(date)"
    ...
    echo "=== WiSig W=$w seed $seed end $(date) rc=$?"
  done
done

echo "WISIG WINDOW SWEEP COMPLETE $(date)"
